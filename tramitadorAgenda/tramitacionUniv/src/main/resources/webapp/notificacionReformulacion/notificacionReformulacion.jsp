...
<script type="text/javascript" src="<s:url value="/modulos/tramitacionUniv/notificacionReformulacion/js/notificacionReformulacion.js"/>"></script>
<!-- CSS  -->
<s:include value="/modulos/tramitacionUniv/templates/head_styles.jsp" />
<script type="text/javascript">
    defineUrlsControladores([ '<s:url action="guardarReformulaUniv" namespace="/agenda/tareas" includeParams="none"/>', '<s:url action="incorporarNotificacionReformulaUniv" namespace="/agenda/tareas" includeParams="none"/>' ]);
</script>
<script type="text/javascript">
...
<body>
	...
	<div class="container-fluid">
		...
		<s:form id="formReformulaUniv" cssClass="form-vertical" theme="simple">
