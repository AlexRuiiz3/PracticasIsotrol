...
public class TareasNotifReformulaUnivAction extends BaseTareasAction {
  /**
   *
   */
  ...
  private final transient Logger log = Logger.getLogger(TareasNotifReformulaUnivAction.class);
  ...
  public String incorporarNotificacionReformula() {
    ...
    try {
      ...
      if (optional.isPresent()) {
        ...
        map.put("tipoInt", finalidadService.obtenerFinalidadByNumExpediente(Long.valueOf(idExpTrewa), true));
        ...
        final String rutaPlantilla = ConstantesTramitacion.PLANTILLA_NOTIFICACION_REFORMULACION_UNIV;
        final String nombreTipoDocumento = ConstantesTramitacion.NOMBRE_DOC_IN_NOTIF_REFORMULACION_UNIV;
        final String nombreInformeSalida = ConstantesTramitacion.NOMBRE_INFORME_SALIDA_NOTIFICACION_REFORMULACION_UNIV;
