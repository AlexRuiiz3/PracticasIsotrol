...
<script type="text/javascript" src="<s:url value="/modulos/tramitacionUniv/validacionPresupuesto/js/validacionPresupuesto.js"/>"></script>
...
<script type="text/javascript">
  $(document) .ready( function() {
    window.tablaValidacionPresupuesto = "#tablaValidacionPresupuesto";
    window.urlRecargaTablaContribuciones = '<s:url action="recargaTablaContribucionesUniv" namespace="/agenda/tareas" includeParams="none"/>';
    window.urlActionValidacionPresupuesto = '<s:url action="guardarValidacionPresupuestoUniv" namespace="/agenda/tareas" includeParams="none"/>';
