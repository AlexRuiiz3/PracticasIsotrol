...
<script type="text/javascript">
  window.finalidadCU = "CU";
  window.tablaExpedientesFinalidadCU = "#tablaExpedientesFinalidadCU";
  
  $(document).ready(function() {
      crearDataTable(window.tablaExpedientesFinalidadCU, columnsComunes, mensajeEmptyComun, window.finalidadCU);
  });
</script>
<s:form id="formDatosPestania1" cssClass="form-vertical" theme="simple">
  <div id="divContainerFinalidadCU" class="container-fluid">
    <div class="card mt-5">
      <div class="card-body">
        <div class="row">
          <div class="col-sm-12">
            <table id="tablaExpedientesFinalidadCU" class="tableCriterios table table-striped table-sm">
              <thead>
                <tr>
