...
<script type="text/javascript">
  window.finalidadAH = "AH";
  window.tablaExpedientesFinalidadAH = "#tablaExpedientesFinalidadAH";
  $(document).ready(function() {
      crearDataTable(window.tablaExpedientesFinalidadAH, columnsComunes, mensajeEmptyComun, window.finalidadAH);
    });
</script>
<s:form id="formDatosPestania1" cssClass="form-vertical" theme="simple">
  <div id="divContainerFinalidadAH" class="container-fluid">
    <div class="card mt-5">
      <div class="card-body">
        <div class="row">
          <div class="col-sm-12">
            <table id="tablaExpedientesFinalidadAH" class="tableCriterios table table-striped table-sm">
              <thead>
                <tr>
