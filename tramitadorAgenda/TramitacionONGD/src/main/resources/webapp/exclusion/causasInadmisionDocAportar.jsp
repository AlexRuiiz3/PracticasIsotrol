...
<script type="text/javascript">
    defineUrlsControladores([ '<s:url action="guardarCausasInadmisionDocumentacionAportar" namespace="/agenda/tareas" includeParams="none"/>' ]);
</script>
</head>
<body>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <div class="checkbox-vertical">
                <input type="checkbox" class="form-check-input" id="noTieneExclusiones" name="datosExclusionDTO.noTieneExclusiones" value="true" <c:if test="${datosExclusionDTO.noTieneExclusiones}">checked</c:if>/>
