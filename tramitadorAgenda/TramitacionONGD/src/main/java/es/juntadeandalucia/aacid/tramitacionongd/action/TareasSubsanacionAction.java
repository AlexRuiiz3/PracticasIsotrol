 ...
 *
 */
public class TareasSubsanacionAction extends BaseTareasAction {
  ...
  private final transient Logger log = Logger.getLogger(TareasSubsanacionAction.class);

  /**
   * Datos de subsanacion.
   */
  ...
  public String generarSubsanacionSolicitud() {
    ...
    try {
      ...
      DocumentoExpedienteDTO doc = tareasService.generarInformes(datosVariables, ConstantesTramitacion.PLANTILLA_SUBSANACION_SOLICITUD_ONGD,
          ConstantesTramitacion.NOMBRE_INFORME_SALIDA_SUBSANACION_SOLICITUD, ConstantesTramitacion.NOMBRE_DOC_IN_SUB_SOLI_ONGD,
          ConstantesTramitacion.NOMBRE_TAREA_GENERAR_INFORME_SUBSANACION_SOLI_ONGD, user);
  ...
  public String buscarTipoCatalogo() {
    try {
      ...
      listaTipoCatalogo = tipoCatalogoService.obtenerCatalogosPorAnio(anio, ConstantesTramitacion.TIPO_CONV_ONGD);
  ...
  public String buscarCatalogo() {
    ...
    try {
      ...
      log.error("Error al obtener los catalogos", e);
      return ERROR;
    }
  ...
  public String guardarSubsanacionesValorador() {
    try {
      ...
      subsanacionService.guardarSubsanacion(subsanacionGuardar, getUsuarioSesion().getExpediente().getRefExpediente(), listadoSubsanaciones,
          ConstantesTramitacion.TIPO_CONV_ONGD, anio);
  ...
  public String generarListadoSubsanaciones() {
    ...
    service.submit(() -> {
      try {
        ...
        final Map<String, Object> datosVariables = subsanacionService.obtenerDatosDocumentoSubsanaciones(user, false);
        DocumentoExpedienteDTO doc = tareasService.generarInformes(datosVariables, ConstantesTramitacion.PLANTILLA_SUBSANACION_CONVOCATORIA_ONGD,
            ConstantesTramitacion.NOMBRE_INFORME_SALIDA_SUBSANACION_CONVOCATORIA, ConstantesTramitacion.NOMBRE_DOC_IN_SUB_CONV_ONGD,
            ConstantesTramitacion.NOMBRE_TAREA_GENERAR_INFORME_SUBSANACION_CONV_ONGD, user);
  ...
  public String generarListadoSubsanacionesAle() {
    ...
    service.submit(() -> {
      try {
        ...
        final Map<String, Object> datosVariables = subsanacionService.obtenerDatosDocumentoSubsanaciones(user, false);
        DocumentoExpedienteDTO doc = tareasService.generarInformes(datosVariables, ConstantesTramitacion.PLANTILLA_SUBSANACION_CONVOCATORIA_VUELTA_ONGD,
            ConstantesTramitacion.NOMBRE_INFORME_SALIDA_SUBSANACION_CONVOCATORIA, ConstantesTramitacion.NOMBRE_DOC_IN_SUB_CONV_ONGD,
            ConstantesTramitacion.NOMBRE_TAREA_GENERAR_INFORME_SUBSANACION_CONV_ALE, user);
  ...
  public String envioEmailDocumentoSubsanacion() {
    user = getUsuarioSesion();
    try {
  ...
  public String cargarListadoSolicitudesSubsanacionesDocumentacion() {
    try {
      user = getUsuarioSesion();
      final ExecutorService service = Executors.newFixedThreadPool(1);
      ...
      service.submit(() -> {
        try {
          ...
          final Map<String, Object> datosVariables = subsanacionService.obtenerDatosDocumentoListadoSubsanacionesDocumentacion(user, false);
          tareasService.generarInformes(datosVariables, ConstantesTramitacion.PLANTILLA_LISTADO_SUBSANACION_DOCUMENTOS_CONVOCATORIA_ONGD,
              ConstantesTramitacion.NOMBRE_INFORME_SALIDA_SUBSANACION_DOCUMENTACION_CONVOCATORIA_ONGD,
              ConstantesTramitacion.NOMBRE_DOC_LIST_SUBSANACIONES_DOCUMENTACION_ONGD,
              ConstantesTramitacion.NOMBRE_TAREA_GENERAR_INFORME_SUBSANACION_DOCUMENTACION_CONV_ONGD, user);
        } catch (final Exception e1) {
          addActionError(e1.getMessage());
          log.error(e1.getMessage(), e1);
        } finally {
  ...
  public String cargarDocumentoSubsanacionDocumentacionAportada() {
    try {
      user = getUsuarioSesion();
      final ExecutorService service = Executors.newFixedThreadPool(1);
      ...
      service.submit(() -> {
        try {
          ...
          tareasService.generarInformes(datosVariables, ConstantesTramitacion.PLANTILLA_SUBSANACION_DOCUMENTACION_APORTADA_SOLICITUD_ONGD,
              ConstantesTramitacion.NOMBRE_INFORME_SALIDA_SUBSANACION_DOCUMENTACION_CONVOCATORIA_ONGD,
              ConstantesTramitacion.NOMBRE_DOC_IN_SUB_DOC_APORT_SOLI_ONGD, ConstantesTramitacion.NOMBRE_TAREA_GENERAR_INFORME_SUBSANACION_DOCUMENTACION_ONGD,
              user);
