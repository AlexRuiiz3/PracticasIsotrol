...
<!--  Exclusiones tipo 2 -->
      <s:if test="listasExclusionesDTO.listaExclusionesExcepcionTipo2!=null && !listasExclusionesDTO.listaExclusionesExcepcionTipo2.isEmpty()">
            ...
            <div class="form-group">
              <div class="col-md-12">
                <div class="list-group checkbox-vertical">
                  <s:checkboxlist cssClass="col-md-12 list-group-item" id="exclusionesTipo2" listKey="idEditar" listValue="descripcion"
                    list="listasExclusionesDTO.listaExclusionesExcepcionTipo2"
                    name="datosExclusionDTO.exclusionesExcepcionTipo2Seleccionadas"
                    theme="simple" />
                </div>
              </div>
            </div>
      ...
      <div id="listadoExclusiones" class="card mb-5">
        ...
        <div class="card-body">
          <div class="form-group">
            <div class="col-md-12">
              <div class="list-group checkbox-vertical">
                <s:checkboxlist cssClass="col-md-12 list-group-item" id="exclusionesComunes" listKey="idEditar" listValue="descripcion"
