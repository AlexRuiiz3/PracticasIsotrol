...
<script type="text/javascript">
    defineUrlsControladores([ '<s:url action="guardarExclusionPosSubsanacion" namespace="/agenda/tareas" includeParams="none"/>' ]);
</script>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <s:form id="formExclusionTrasSubsanacion" cssClass="form-vertical" theme="simple">
      ...
      <s:if test="listasExclusionesDTO.listaExclusionesComunes!=null && !listasExclusionesDTO.listaExclusionesComunes.isEmpty()">
      ...
      <s:if test="listasExclusionesDTO.listaExclusionesInadDesestimiento!=null && !listasExclusionesDTO.listaExclusionesInadDesestimiento.isEmpty()">
        <div id="listadoExclusiones" class="card mb-5">
          <div class="card-header">
            <h5>
        ...
        <div class="card-body">
          <div class="form-group">
            <h6 class="col-md-12 border-bottom" for="exclusionesDesistimiento">
              <s:text name="grupo.exclusion.causas.inadmision.desistimiento" />
            </h6>
            <div class="col-md-12">
              <div class="list-group checkbox-vertical">
                <s:checkboxlist cssClass="col-md-12 list-group-item"
                  id="exclusionesDesistimiento" listKey="idEditar"
                  listValue="descripcion"
                  list="listasExclusionesDTO.listaExclusionesInadDesestimiento"
                  name="datosExclusionDTO.exclusionesInadmisionSeleccionadas"
                  theme="simple" />
              </div>
            </div>
          </div>
          <div class="form-group">
            <h6 class="col-md-12 border-bottom" for="exclusionesProyCooperacion">
              <s:text name="grupo.exclusion.proyectos.cooperacion" />
            </h6>
            <div class="col-md-12">
              <div class="list-group checkbox-vertical">
                <s:checkboxlist cssClass="col-md-12 list-group-item"
          ...
          <div class="form-group">
            <h6 class="col-md-12 border-bottom" for="exclusionesProyHumanitaria">
              <s:text name="grupo.exclusion.proyectos.accion.humanitaria" />
            </h6>
            <div class="col-md-12">
              <div class="list-group checkbox-vertical">
                <s:checkboxlist cssClass="col-md-12 list-group-item"
                  id="exclusionesProyHumanitaria" listKey="idEditar"
                  listValue="descripcion"
                  list="listasExclusionesDTO.listaExclusionesProyectosAccHumanitaria"
                  name="datosExclusionDTO.exclusionesProyAccHumanitariaSeleccionadas"
                  theme="simple" />
              </div>
            </div>
          </div>
