...
<head>
  ...
  <script type="text/javascript" src="<s:url value="/modulos/tramitacionONGD/subsanacion/js/creacionSubsanacion.js"/>" ></script>
  <!-- CSS  -->
...
<div id="divContainerDatosSubsanacion" class="container-fluid">
  ...
  <s:form action="/guardarSubsanacion.action" theme="simple">
    <div class="card mb-5">
