...
<title><s:text name="fieldset.generarInforme.listado.subsanacion.documentacion" /></title>
</head>
<body>
  ...
  <div class="container-fluid">
    <div class="card mb-5 mt-5">
      <div class="card-header">
        <h5>
          <s:text name="fieldset.generarInforme.listado.subsanacion.documentacion" />
        </h5>
      </div>
