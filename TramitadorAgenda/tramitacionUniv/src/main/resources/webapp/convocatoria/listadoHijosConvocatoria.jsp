...
<script type="text/javascript"
	src="<s:url value="/modulos/tramitacionUniv/convocatoria/js/listadoSolicitudes.js"/>"></script>
<!-- CSS  -->
					...
					<table id="listadoSolicitudes"
						...
						<thead class="thead-dark">
							<tr>
								...
								<th
									title='<s:text name="tabla.hijos.convocatoria.col.1.title"/>'><s:text
										name="tabla.hijos.convocatoria.col.1.title" /></th>
								<th
