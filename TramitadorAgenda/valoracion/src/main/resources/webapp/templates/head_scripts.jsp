...
<script type="text/javascript" src="<s:url value='/modulos/valoracion/js/jquery/jquery.validate.js' />"></script>
<script type="text/javascript" src="<s:url value='/modulos/valoracion/js/jquery/messages_es.js' />"></script>

<!-- Específico -->
<script type="text/javascript" src="<s:url value="/modulos/valoracion/js/validatePestanias.js"/>" ></script>
<script type="text/javascript" src="<s:url value="/modulos/valoracion/js/bignumber/bignumber.js"/>" ></script>

<!-- IOS OVERLAY JS -->
<script type="text/javascript" src="<s:url value="/modulos/valoracion/js/ios-overlay/iosOverlay.js" includeParams="none"/>"></script>
<script type="text/javascript" src="<s:url value="/modulos/valoracion/js/ios-overlay/spin.min.js" includeParams="none"/>"></script>
