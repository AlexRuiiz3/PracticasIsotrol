...
<script type="text/javascript">
  window.finalidadF = "F";
  window.tablaExpedientesFinalidadF = "#tablaExpedientesFinalidadF";

  $(document).ready(function() {
      crearDataTable(window.tablaExpedientesFinalidadF, columnsComunes, mensajeEmptyComun, window.finalidadF);
  });
</script>
<s:form id="formDatosPestania1" cssClass="form-vertical" theme="simple">
  <div id="divContainerFinalidadF" class="container-fluid">
    <div class="card mt-5">
      <div class="card-body">
        <div class="row">
          <div class="col-sm-12">
            <table id="tablaExpedientesFinalidadF" class="tableCriterios table table-striped table-sm">
              <thead>
                <tr>
