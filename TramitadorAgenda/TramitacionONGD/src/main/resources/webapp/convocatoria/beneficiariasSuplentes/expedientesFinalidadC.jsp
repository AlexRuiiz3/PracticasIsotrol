...
<script type="text/javascript">
  window.finalidadC = "C";
  window.tablaExpedientesFinalidadC = "#tablaExpedientesFinalidadC";
  
  $(document).ready(function() {
      crearDataTable(window.tablaExpedientesFinalidadC, columnsComunes, mensajeEmptyComun, window.finalidadC);
  });
</script>
<s:form id="formDatosPestania1" cssClass="form-vertical" theme="simple">
  <div id="divContainerFinalidadC" class="container-fluid">
    <div class="card mt-5">
      <div class="card-body">
        <div class="row">
          <div class="col-sm-12">
            <table id="tablaExpedientesFinalidadC" class="tableCriterios table table-striped table-sm">
              <thead>
                <tr>
