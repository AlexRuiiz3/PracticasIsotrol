...
<html lang="es">
<head>
<title><s:text name="title.exclusiones.causasDesestimiento" /></title>
<!-- Scripts -->
...
<script type="text/javascript">
    defineUrlsControladores([ '<s:url action="guardarCausasDesestimacion" namespace="/agenda/tareas" includeParams="none"/>' ]);
</script>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <s:form id="formCausasDesestimiento" cssClass="form-vertical" theme="simple">
      <s:hidden name="datosExclusionDTO.idSolicitud" />
      <div id="listadoExclusiones" class="card mb-5">
        <div class="card-header">
          <h5>
            <s:text name="fieldset.causasExclusion.causasDesestimiento" />
          </h5>
        </div>
        <div class="card-body">
      ...
      <div class="float-right mt-4 mb-4">
        <input class="btn btn-success btn-space" type="button" id="btnGuardar"
          value="GUARDAR" onclick="createOrUpdateExclusion('formCausasDesestimiento')" /> <input
