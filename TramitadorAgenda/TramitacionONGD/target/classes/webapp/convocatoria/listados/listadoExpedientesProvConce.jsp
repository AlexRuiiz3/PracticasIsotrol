...
<script type="text/javascript" src="<s:url value="/modulos/tramitacionONGD/convocatoria/listados/js/listadoExpedientes.js"/>"></script>
...
<script type="text/javascript">
  ...
  initParametrizacionListadoExpedientes(
      [ '<s:text name="tabla.listadoExpedientes.col.0.title"/>',
          ...
          '<s:text name="tabla.listadoExpedientes.col.7.title"/>'
      ],
      [ '<s:text name="tabla.listadoExpedientes.col.0.width"/>',
          ...
          '<s:text name="tabla.listadoExpedientes.col.7.width"/>'
      ],
          ...
          <table id="tablaExpedientesProvConce" class="table table-bordered table-sm">
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col" class="centradoVertical text-center" title='<s:text name="tabla.listadoExpedientes.col.7.title"/>'/>
              </tr>
            </thead>
          </table>
        </div>
