 ...
 *
 */
public class AlegacionesException extends Exception {
   ...
   */
  public AlegacionesException(final String texto) {
   ...
   */
  public AlegacionesException(final String texto, final Throwable e) {
    super(texto, e);
  }
}
